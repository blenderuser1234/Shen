...
bot = telebot.TeleBot('7717577857:AAEihU361CPgzfDQS2GP87gYdfINs72lCVQ')
# Admin user IDs
admin_id = ["6444435371"]
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                response = f"DAWNCHEATS 🚀\nAttack1 Finished. \n📡 Target: {target} \n🔌 Port: {port} \n⏱️ Time: {time} \n BY https://t.me/DAWNCHEATS"
        else:
            response = "Usage :- /attack1 <target> <port> <time>\nBy https://t.me/DAWNCHEATS"  # Updated command syntax
    else:
        response = "You Are Not User's To Authorized To Use This Command.\nBy DAWN BOT DM TO GET ACCESS @DAWNCHEATS"
